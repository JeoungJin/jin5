...
public class StringTest {
	...
	private static void f6() {
		//기본형타입 : 값저장, 연산, 비교
		//참조형 : 기본형 + 기능==>Wrapper class(포장class)
		int a = 100;
		...
		System.out.println("소->대 :" + Character.toUpperCase(v1));
		
		
		System.out.println(a+100>200?"yes":"no");
		
		
	}

	private static void f5() {
		String str = "이것이 자바다 데이타베이스,웹 리엑트js";
	...
	private static void f3() {
		...
		System.out.println(s1.replace("자", "JAVA"));
	...
	private static void f1() {
		...
		System.out.println((int)'바');
		String s5;
		try {
			s5 = new String(arr2, "ISO-8859-1");
