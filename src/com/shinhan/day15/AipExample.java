...
//모든종목의 체결가 종목이름과 trade_price를 출력하기 
...
public class AipExample {
	...
	public static int f_1(String market) throws IOException {
		String strUrl = "https://api.bithumb.com/v1/trades/ticks?market=" + market;
		URL url = new URL(strUrl);
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
		conn.setRequestMethod("GET");//대소문자구분 
		conn.setRequestProperty("Accept", "application/json");
